...
<div class="container">
  ...
  {:else}
    <h2 class="error">
      Não foi possível obter a política de privacidade, por motivo de um erro interno do serviço ou falha na conexão à
      rede internet, tente novamente mais tarde, não conclua o sua contratação sem ler os termos de uso de serviço e
